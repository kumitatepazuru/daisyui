import{S as Jt,i as Ct,s as Lt,M as jt,y as nt,z as ut,A as $t,U as St,$ as Ut,g as ht,d as ft,B as mt,H as At,Y as Pt,a as w,c as g,b as X,h as a,k as c,q as m,l as o,m as i,r as p,n as e,E as t,F as _t,a9 as wt,a4 as gt,C as ot,D as vt,K as Ot}from"../chunks/index.b33eaa49.js";import{M as Wt}from"../chunks/mdsvex.6b1cfd2f.js";import{p as qt,C as Gt,a as pt,r as Et}from"../chunks/ClassTable.2bc7c724.js";function Ht(R){let s,l,v,u,n,h,r,$,D,y;return{c(){s=c("div"),l=c("div"),v=c("div"),u=m("Total Page Views"),n=w(),h=c("div"),r=m("89,400"),$=w(),D=c("div"),y=m("21% more than last month"),this.h()},l(M){s=o(M,"DIV",{class:!0});var V=i(s);l=o(V,"DIV",{class:!0});var _=i(l);v=o(_,"DIV",{class:!0});var K=i(v);u=p(K,"Total Page Views"),K.forEach(a),n=g(_),h=o(_,"DIV",{class:!0});var B=i(h);r=p(B,"89,400"),B.forEach(a),$=g(_),D=o(_,"DIV",{class:!0});var E=i(D);y=p(E,"21% more than last month"),E.forEach(a),_.forEach(a),V.forEach(a),this.h()},h(){e(v,"class","stat-title"),e(h,"class","stat-value"),e(D,"class","stat-desc"),e(l,"class","stat"),e(s,"class","shadow stats")},m(M,V){X(M,s,V),t(s,l),t(l,v),t(v,u),t(l,n),t(l,h),t(h,r),t(l,$),t(l,D),t(D,y)},p:_t,d(M){M&&a(s)}}}function Yt(R){let s,l=`<div class="$$stats shadow">
